-- Create a lightning-fast RPC for advancing flask stages to avoid N+1 sequential API queries.
...
DECLARE
  ...
  v_batch_status TEXT;
  v_stage_ranks TEXT[] := ARRAY['inoculation', 'fermentation', 'harvest', 'straining', 'extract_addition', 'qc_hold', 'released', 'rejected'];
  v_slowest_rank INT;
  v_rank INT;
  v_flask RECORD;
