  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div><h2 className="text-xl font-bold text-gray-900 tracking-tight">CAPA Manager</h2><p className="text-sm text-gray-500 mt-1">Non-Conformance & Action items.</p></div>
