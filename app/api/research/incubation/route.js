...
export async function GET(request) {
  try {
    ...
    let query = supabase
      ...
      .select('*, employees(full_name), batches(batch_id, status), batch_flasks(flask_label), batch_flask_qc_samples(sample_id), samples(sample_label, source_type, source_label, log_hour, timepoint_label, flask_label)')
