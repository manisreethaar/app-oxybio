      ...
      {endpoint && (
        <div className="card p-5 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button disabled={actionLoading} onClick={() => onAdvanceFlaskStage(activeFlask.id, 'harvest')} className="px-5 py-2.5 bg-navy hover:bg-navy-hover text-white font-bold rounded-xl text-xs uppercase tracking-wider shadow-sm disabled:opacity-50">
