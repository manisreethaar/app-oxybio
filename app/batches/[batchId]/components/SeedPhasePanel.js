        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
            {stageFlasks.map(f => {
              ...
              return (
                <div key={f.id} className="card border-2 p-5 border-navy/10 hover:border-navy/30">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                    ...
                    <button onClick={() => { setSelectedFlaskId(f.id); setShowLogModal(true); }} className="px-4 py-2 bg-navy/10 text-navy text-xs font-black rounded-lg hover:bg-navy/20 flex items-center gap-1">
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 w-full max-w-md shadow-2xl animate-in zoom-in-95">
            ...
            <div className="space-y-3">
              {stageType === 'seed_1' && (
                <button onClick={() => executeStageTransfer('seed_2')} className="w-full p-4 border-2 border-slate-200 rounded-xl hover:border-navy hover:bg-navy/5 text-left transition-all">
              ...
              {(stageType === 'seed_1' || stageType === 'seed_2') && (
                <button onClick={() => executeStageTransfer('seed_3')} className="w-full p-4 border-2 border-slate-200 rounded-xl hover:border-navy hover:bg-navy/5 text-left transition-all">
