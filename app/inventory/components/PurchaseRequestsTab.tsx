          ...
          <div key={r.id} className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex justify-between items-center">
            ...
            <div className="flex flex-col items-end gap-2">
              <span className={`px-3 py-1 rounded-full text-xs font-black uppercase ${
                ...
                r.status === 'Fulfilled' ? 'bg-violet-100 text-violet-800' :
              ...
              {canApprove && r.status === 'Approved' && (
                <button onClick={() => handleStatus(r.id, 'Fulfilled')} className="mt-2 px-3 py-1.5 bg-violet-50 text-violet-700 hover:bg-violet-100 rounded-lg text-[10px] font-black uppercase flex items-center">
