    ...
    return (
      <form onSubmit={modalType === 'edit_stock' ? handleUpdateStock : handleAddStock} className="p-5 sm:p-6 pb-24 space-y-5 overflow-y-auto max-h-[calc(90vh-80px)] custom-scrollbar">
        <div className="grid grid-cols-1 gap-5">
          <div>
            <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Inventory Item</label>
          ...
          <div>
            <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Supplier / Vendor</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">{modalType === 'edit_stock' ? 'Current Quantity' : 'Quantity Recvd'}</label>
            ...
            <div>
              <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Supplier Batch #</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Expiry Date</label>
            ...
            <div>
              <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Warehouse Location</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">PO Number (Optional)</label>
            ...
            <div>
              <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Invoice / Delivery Ref</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Condition on Arrival</label>
            ...
            <div>
              <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Initial Status</label>
  ...
  if (modalType === 'issue') {
    return (
      <form onSubmit={handleIssueStock} className="p-5 sm:p-6 pb-24 space-y-5 overflow-y-auto max-h-[calc(90vh-80px)] custom-scrollbar">
        <div>
          <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Select Stock Item</label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Quantity Issued</label>
          ...
          <div>
            <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Purpose</label>
        ...
        <div>
          <label className="block text-xs font-black uppercase text-gray-400 tracking-widest mb-2">Batch Reference (Optional)</label>
