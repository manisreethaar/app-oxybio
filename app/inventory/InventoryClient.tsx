...
export default function InventoryClient({ initialStock, initialItems, initialVendors }: { initialStock: any[], initialItems: any[], initialVendors: any[] }) {
  ...
  const handleSeedCategories = async () => {
    ...
    const catalogData = {
      ...
      "ANALYTICAL INSTRUMENTS": ["Bench top pH meter", "STEREO MICROSCOPE WITH LED LIGHT", "Hand held refractometer", "Centrifuge (Micro centrifuge)", "Ultrasonic bath (sonicator)", "LABORATORY WEIGHING SCALE"],
