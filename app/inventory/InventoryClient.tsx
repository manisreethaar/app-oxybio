                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {catItems.map(item => (
                    <div
                      ...
                      className={`bg-white rounded-3xl border p-6 shadow-sm relative group overflow-hidden transition-all ${
                        isSelectMode ? 'cursor-pointer' : ''
                      } ${selectedItemIds.has(item.id) ? 'border-red-400 ring-2 ring-red-200 bg-red-50/30' : 'border-gray-100'}`}
                    >
