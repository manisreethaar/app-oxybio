...
export default function InsightsAnalyticsClient({ initialBatches = [], initialReadings = [], initialEndpoints = [], initialTasks = [], initialNotes = [], initialProducts = [] }) {
