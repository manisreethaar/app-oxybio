...
// ── Main Page ────────────────────────────────────────────────────────────────
export default function BioprocessAnalyticsClient({ initialBatches = [], initialReadings = [], initialEndpoints = [], initialTitrationLogs = [], initialProducts = [] }) {
  ...
  const [titrationLogs, setTitrationLogs] = useState(initialTitrationLogs);
