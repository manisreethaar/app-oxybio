...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function TaClient({ initialLogs, initialBatches, initialExperiments, initialInventoryItems }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-fade-in pb-32 md:pb-8">
      ...
      <div className="glass-card rounded-2xl border border-slate-200 bg-slate-50 p-4 flex flex-wrap gap-6 items-center">
      ...
      {stats && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            <div key={s.label} className={`glass-card rounded-2xl p-4 border ${s.highlight ? 'border-amber-200 bg-amber-50' : 'border-slate-200'}`}>
      ...
      {/* ── Filters ─────────────────────────────────────────────────────── */}
      <div className="glass-card rounded-2xl border border-slate-200 p-4 flex flex-wrap gap-3 items-center">
