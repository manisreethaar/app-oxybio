        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-gray-50 rounded-xl font-bold text-sm border-none ring-1 ring-gray-200 focus:ring-2 focus:ring-teal-600 transition-all outline-none"
            />
          </div>
          <div>
          ...
          <button
            ...
            className="w-full py-4 bg-teal-800 text-white font-black uppercase tracking-widest text-[10px] rounded-2xl shadow-xl shadow-teal-900/20 hover:bg-teal-900 transition-all active:scale-95 flex items-center justify-center gap-2"
          >
