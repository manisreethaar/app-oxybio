...
export default function ProductDevelopmentDashboard() {
  ...
  const fetchBatches = useCallback(async () => {
    ...
    if (error) toast.error('Failed to load product development batches');
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-xl max-h-[80vh] flex flex-col">
            ...
            <div className="overflow-y-auto flex-1 p-2">
              {pickerLoading ? (
                <div className="flex justify-center p-8"><div className="animate-spin w-6 h-6 border-4 border-indigo-600 border-t-transparent rounded-full" /></div>
