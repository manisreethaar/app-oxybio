        ...
        <div className="lg:col-span-1">
          <div className="surface p-6">
            ...
            <form onSubmit={handleSubmit(handleApplyForm)} className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold uppercase text-slate-400 tracking-wider mb-1.5">Leave Category</label>
                {isClOnly && (
              ...
              {isPermission ? (
                <div className="space-y-3 p-4 bg-slate-50/50 rounded-xl border border-slate-100">
                  <p className="text-[10px] font-bold text-slate-700 uppercase tracking-wider">Short Leave — Hours Based</p>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-bold uppercase text-slate-400 tracking-wider mb-1.5">Start Date</label>
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase text-slate-400 tracking-wider mb-1.5">End Date</label>
              ...
              {!isPermission && calculateDays() > 0 && (
                <p className="text-[10px] font-black text-navy bg-slate-100 py-1.5 px-3 rounded-md border border-slate-200 uppercase tracking-widest">
              ...
              <table className="min-w-full divide-y divide-gray-100">
                <thead>
                  <tr className="bg-slate-50/50">
                    <th className="px-6 py-3 text-left text-[10px] font-bold text-slate-400 uppercase tracking-wider">Category</th>
                    <th className="px-6 py-3 text-left text-[10px] font-bold text-slate-400 uppercase tracking-wider">Cycle</th>
                    <th className="px-6 py-3 text-center text-[10px] font-bold text-slate-400 uppercase tracking-wider">Net Days</th>
                    <th className="px-6 py-3 text-right text-[10px] font-bold text-slate-400 uppercase tracking-wider">Status</th>
                  </tr>
                </thead>
