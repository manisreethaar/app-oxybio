...
export default function FormulationsClient({ initialFormulations = [], initialItems = [], initialPendingIds = [] }) {
                    ...
                    <div className="mt-auto space-y-2">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        ...
                        <button 
                          ...
                          className="py-2 rounded-lg text-xs font-black uppercase tracking-widest border bg-white text-navy border-slate-200 hover:bg-slate-50 transition-all flex items-center justify-center gap-1.5"
                        >
                              ...
                              <div className="space-y-1.5">
                                {batchHistory[f.id].map(b => {
                                  ...
                                  const bStatusColor =
                                    ...
                                    bStatus === 'scheduled'  ? 'bg-slate-50 text-navy border-slate-200' :
