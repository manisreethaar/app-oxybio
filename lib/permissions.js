...
const PERMISSIONS = {
  ...
  batches: {
    ...
    // ───────────────────────────────────────────────────────────────
    log_reading:      ALL_ROLES,                                           // fermentation readings — all roles (intern = supervised)
    media_prep:       ALL_ROLES,                                           // all roles (intern/research_intern = supervised)
    sterilisation:    [...SCIENTISTS, 'research_intern'],                  // scientist+ or research_intern (supervised)
    inoculation:      [...SCIENTISTS, 'research_intern'],                  // scientist+ or research_intern (supervised)
    straining:        ALL_ROLES,                                           // all roles (intern/research_intern = supervised)
    extract_addition: [...SCIENTISTS, 'research_intern'],                  // scientist+ or research_intern (supervised)
    qc_entry:         [...SCIENTISTS, 'research_intern'],                  // scientist+ or research_intern (supervised)
    declare_endpoint: [...SCIENTISTS, 'research_intern'],                  // scientist+ or research_intern (supervised)
