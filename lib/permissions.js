...
const PERMISSIONS = {
  ...
  batches: {
    view:             ALL_ROLES,
    create:           SENIOR,                                              // research_fellow+

    // ── Stage data entry ───────────────────────────────────────────────
    // Supervised entry in UI: intern/research_intern must select a supervisor
    log_reading:      ALL_ROLES,                                           // all roles (intern = supervised)
    media_prep:       [...SCIENTISTS, 'research_intern'],                  // scientist+ or research_intern (supervised)
    sterilisation:    SCIENTISTS,                                          // scientist+
    inoculation:      SENIOR,                                             // research_fellow+
    straining:        [...SCIENTISTS, 'research_intern'],                  // scientist+ or research_intern (supervised)
    extract_addition: SENIOR,                                             // research_fellow+
    qc_entry:         SCIENTISTS,                                          // scientist+
    declare_endpoint: SENIOR,                                             // research_fellow+

    // ── Disposition (terminal actions) ────────────────────────────────
    ...
    // Legacy (kept for existing code that uses canDo('batches','edit'))
    edit:             ALL_ROLES,
    sign_off:         LEADERSHIP,
  },
