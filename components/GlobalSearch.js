...
const ALL_ROUTES = [
  ...
  { name: 'TA Lab (Titratable Acidity)', href: '/lab-bench/ta',           category: 'Lab',        keywords: ['titration', 'titratable acidity', 'TA', 'lactic', 'acid', 'burette'] },
  ...
  { name: 'Bioprocess Analytics',   href: '/analytics/bioprocess',       category: 'R&D',        keywords: ['kinetics', 'growth rate', 'mu', 'yield', 'anomaly', 'TA', 'acid curve', 'fermentation analytics'] },
