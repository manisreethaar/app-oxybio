...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 z-[60] flex flex-col justify-end p-0 sm:p-4 bg-slate-900/40 backdrop-blur-sm">
          <div className="h-[calc(100dvh-68px-env(safe-area-inset-bottom,0px))] sm:h-auto sm:max-h-[90vh] overflow-hidden bg-white/90 backdrop-blur-xl w-full shadow-2xl flex flex-col animate-in slide-in-from-bottom border-t border-white/50">
